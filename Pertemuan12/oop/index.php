...
<body>
    <div class="container at-5">
        <button type="button" class="btn btn-success sb-3" data-toggle="modal" data-target="#tambahModal"> Tambah</button>
            <table class="table">
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <div class="modal-body">
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" class="form-control" id="keterangan" cols="38" rows="10" required></textarea>
                        </div>
