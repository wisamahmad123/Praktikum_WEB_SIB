    ...
    <body>
        ...
        <table>
            ...
            <?php
                ...
                echo "</tr>";
                // mendefinisikan sebuah array multidimensi bernama $movie yang berisi daftar film
            
            ?>
        </table>
    </body>
</html>
<!-- kode pada class ini menghasilkan halaman HTML yang menampilkan daftar film dari array multidimensi dalam sebuah tabel -->